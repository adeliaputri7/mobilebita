...
class DetailKataKerjaPage extends StatefulWidget {
  final String kata;
  final String? gambarUrl;
  final String? videoUrl;
  final String? deskripsi;

  const DetailKataKerjaPage({
    Key? key,
    required this.kata,
    this.gambarUrl,
    this.videoUrl,
  ...
  @override
  _DetailKataKerjaPageState createState() => _DetailKataKerjaPageState();
}

class _DetailKataKerjaPageState extends State<DetailKataKerjaPage> {
