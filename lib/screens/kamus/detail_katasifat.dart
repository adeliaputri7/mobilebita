...
class DetailKataSifatPage extends StatefulWidget {
  final String kata;
  final String? gambarUrl;
  final String? videoUrl;
  final String? deskripsi;

  const DetailKataSifatPage({
    Key? key,
    required this.kata,
    this.gambarUrl,
    this.videoUrl,
  ...
  @override
  _DetailKataSifatPageState createState() => _DetailKataSifatPageState();
}

class _DetailKataSifatPageState extends State<DetailKataSifatPage> {
